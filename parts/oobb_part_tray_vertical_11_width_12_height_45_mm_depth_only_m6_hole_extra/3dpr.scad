...
difference() {
				...
				translate(v = [0, 0, 2.9925000000]) {
					hull() {
						union() {
							...
							translate(v = [-77.0000000000, 84.5000000000, 86]) {
								sphere(r = 4);
							}
						}
						union() {
	...
	union() {
		translate(v = [0, 0, 2.9925000000]) {
			hull() {
				union() {
					...
					translate(v = [-79.0000000000, 86.5000000000, 28]) {
						sphere(r = 2);
					}
				}
				union() {
		...
		translate(v = [-75.0000000000, 90.0000000000, 52.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
		translate(v = [-60.0000000000, 90.0000000000, 52.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
		translate(v = [-45.0000000000, 90.0000000000, 52.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
