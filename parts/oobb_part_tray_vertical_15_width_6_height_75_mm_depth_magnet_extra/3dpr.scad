...
difference() {
	...
	union() {
		...
		#translate(v = [-105.0000000000, 45.0000000000, 82.5000000000]) {
			rotate(a = [90, 0, 0]) {
		...
		#translate(v = [-90.0000000000, 45.0000000000, 82.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 1.8000000000);
			}
		}
		...
		#translate(v = [-75.0000000000, 45.0000000000, 82.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 1.8000000000);
			}
		}
