...
| id_oobb | oobb_part_oomlout_oobb_part_tray_vertical_tray_vertical_12_width_11_height_90_mm_depth |  
| kwargs | {'filter': '', 'height': 11, 'modes': ['3dpr'], 'navigation': True, 'oomp_classification': 'oobb', 'oomp_color': '', 'oomp_description_extra': '', 'oomp_description_main': '12_width_11_height_90_mm_depth', 'oomp_manufacturer': '', 'oomp_mode': 'oobb', 'oomp_part_number': '', 'oomp_run': True, 'oomp_size': 'tray_vertical', 'oomp_type': 'part', 'overwrite': False, 'thickness': 90, 'typ': 'all', 'type': 'oomlout_oobb_part_tray_vertical_tray_vertical', 'width': 12} |  
| manufacturer |  |  
| name | tray_vertical |  
| part_number |  |  
