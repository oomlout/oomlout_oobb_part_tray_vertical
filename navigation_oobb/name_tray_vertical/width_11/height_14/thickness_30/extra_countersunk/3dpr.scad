...
difference() {
				...
				translate(v = [0, 0, 2.9925000000]) {
					hull() {
						union() {
							...
							translate(v = [-77.0000000000, 99.5000000000, 71]) {
								sphere(r = 4);
							}
						}
						union() {
	...
	union() {
		translate(v = [-75.0000000000, 102.0000000000, 37.5000000000]) {
			rotate(a = [90, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [-60.0000000000, 102.0000000000, 37.5000000000]) {
			rotate(a = [90, 0, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -15.0000000000]) {
		...
		translate(v = [-45.0000000000, 102.0000000000, 37.5000000000]) {
			rotate(a = [90, 0, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -15.0000000000]) {
		...
		translate(v = [0, 0, 2.9925000000]) {
			hull() {
				union() {
					...
					translate(v = [-79.0000000000, 101.5000000000, 13]) {
						sphere(r = 2);
					}
				}
				union() {
