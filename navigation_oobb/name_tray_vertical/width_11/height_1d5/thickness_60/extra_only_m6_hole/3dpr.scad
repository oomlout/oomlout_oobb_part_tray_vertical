...
difference() {
	...
	union() {
		...
		translate(v = [-75.0000000000, 11.2500000000, 67.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
		translate(v = [-60.0000000000, 11.2500000000, 67.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
		translate(v = [-45.0000000000, 11.2500000000, 67.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
