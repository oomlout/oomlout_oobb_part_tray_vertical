...
| id_oobb | oobb_part_oomlout_oobb_part_tray_vertical_tray_vertical_14_width_6_height_90_mm_depth |  
| kwargs | {'filter': '', 'height': 6, 'modes': ['3dpr'], 'navigation': True, 'oomp_classification': 'oobb', 'oomp_color': '', 'oomp_description_extra': '', 'oomp_description_main': '14_width_6_height_90_mm_depth', 'oomp_manufacturer': '', 'oomp_mode': 'oobb', 'oomp_part_number': '', 'oomp_run': True, 'oomp_size': 'tray_vertical', 'oomp_type': 'part', 'overwrite': False, 'thickness': 90, 'typ': 'all', 'type': 'oomlout_oobb_part_tray_vertical_tray_vertical', 'width': 14} |  
| manufacturer |  |  
| name | tray_vertical |  
| part_number |  |  
