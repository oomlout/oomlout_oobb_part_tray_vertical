...
difference() {
				...
				translate(v = [0, 0, 2.9925000000]) {
					hull() {
						union() {
							...
							translate(v = [-77.0000000000, 47.0000000000, 131]) {
								sphere(r = 4);
							}
						}
						union() {
	...
	union() {
		translate(v = [-75.0000000000, 49.5000000000, 97.5000000000]) {
			rotate(a = [90, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [-60.0000000000, 49.5000000000, 97.5000000000]) {
			rotate(a = [90, 0, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -15.0000000000]) {
		...
		translate(v = [0, 0, 2.9925000000]) {
			hull() {
				union() {
					...
					translate(v = [-79.0000000000, 49.0000000000, 73]) {
						sphere(r = 2);
					}
				}
				union() {
