	...
	union() {
		difference() {
			...
			union() {
				...
				translate(v = [0, 0, 2.9925000000]) {
					hull() {
						union() {
							...
							translate(v = [-39.5000000000, 47.0000000000, 86]) {
								sphere(r = 4);
							}
						}
						union() {
				...
				translate(v = [-37.5000000000, 52.5000000000, 52.5000000000]) {
					rotate(a = [90, 0, 0]) {
				...
				translate(v = [-22.5000000000, 52.5000000000, 52.5000000000]) {
					rotate(a = [90, 0, 0]) {
						cylinder(h = 3, r = 3.2500000000);
					}
				}
		...
		translate(v = [0, 0, 2.9925000000]) {
			hull() {
				union() {
					...
					translate(v = [-41.5000000000, 49.0000000000, 28]) {
						sphere(r = 2);
					}
				}
				union() {
