...
difference() {
	...
	union() {
		translate(v = [-105.0000000000, 102.0000000000, 37.5000000000]) {
			rotate(a = [90, 0, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -3.0000000000]) {
		...
		translate(v = [-90.0000000000, 102.0000000000, 37.5000000000]) {
			rotate(a = [90, 0, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -3.0000000000]) {
		...
		translate(v = [0, 0, 2.9925000000]) {
			hull() {
				union() {
					...
					translate(v = [-109.0000000000, 101.5000000000, 13]) {
						sphere(r = 2);
					}
				}
				union() {
