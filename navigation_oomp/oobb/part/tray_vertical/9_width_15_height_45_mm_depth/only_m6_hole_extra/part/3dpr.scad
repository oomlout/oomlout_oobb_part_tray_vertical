...
difference() {
				...
				translate(v = [0, 0, 2.9925000000]) {
					hull() {
						union() {
							...
							translate(v = [-62.0000000000, 107.0000000000, 86]) {
								sphere(r = 4);
							}
						}
						union() {
	...
	union() {
		translate(v = [0, 0, 2.9925000000]) {
			hull() {
				union() {
					...
					translate(v = [-64.0000000000, 109.0000000000, 28]) {
						sphere(r = 2);
					}
				}
				union() {
		...
		translate(v = [-60.0000000000, 112.5000000000, 52.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
		translate(v = [-45.0000000000, 112.5000000000, 52.5000000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 15, r = 3.2500000000);
			}
		}
